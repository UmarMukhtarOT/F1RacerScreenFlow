...
namespace Assets.SimpleAndroidNotifications
{
    ...
    {
        private const string FirstTimeNotification = "FirstTimeNotification";

        private string GameName = "Sports Car Stunts";
        private string message = "Time to do Stunts";
        private void Start()
        {
            SendNotification();
        }
        ...
        public void ScheduleCustom()
        {
            var notificationParams = new NotificationParams
            {
                ...
                Title = "Sports Car Stunts",
                Message = "Time to do Stunts!",
                Ticker = "Ticker",
                Sound = true,
                Vibrate = true,
                Light = true,
